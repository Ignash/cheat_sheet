...
_.fill(array, 'a');// => ['a', 'a', 'a']`,
    },
    {
        ...
        exemple: `_.findIndex(users, { 'user': 'fred', 'active': false });// => 1`,
    },
    {
        block: "Array",
        name: "_.findLastIndex",
        description:
            " This method is like _.findIndex except that it iterates over elementsof collection from right to left.",
        exemple: ``,
    },
    {
        block: "Array",
    ...
    },
    {
        ...
        exemple: `_.indexOf([1, 2, 1, 2], 2, 2);// => 3`,
    },
    {
        block: "Array",
        name: "_.initial",
...

    {
        ...
        name: "_.lastIndexOf",
        description:
            "This method is like _.indexOf except that it iterates over elements ofarray from right to left.",
        exemple: ``,
    },
...
const evens = _.remove(array, (n)=> n % 2 == 0);// array => [1, 3]
// evens => [2, 4]`,
    },
...
;// => [['a', 1, true], ['b', 2, false]]`,
...

    {
        ...
        exemple: `_.every([true, 1, null, 'yes'], Boolean);// => false`,
    },
...

    {
        ...
        exemple: `const users = [{ 'user': 'barney',  'age': 36, 'active': true },
             { 'user': 'fred',    'age': 40, 'active': false },];
_.find(users, (o) => o.age < 40);// => object for 'barney'`,
    },
...
// => { '4': [4.2], '6': [6.1, 6.3] }`,
...

    {
        ...
        exemple: `_.includes([1, 2, 3], 1);// => true`,
    },
...
// => [[1, 5, 7], [1, 2, 3]]`,
...

    {
        ...
        description:
            "Creates an object composed of keys generated from the results of runningeach element of collection thru iteratee.",
        exemple: `const array = [{ 'dir': 'left', 'code': 97 },
             { 'dir': 'right', 'code': 100 }];
...
// => [16, 64] (iteration order is not guaranteed)`,
...

    {
        ...
        exemple: `const users = [{ 'user': 'b',   'age': 48 },{ 'user': 'a', 'age': 34 },
             { 'user': 'b',   'age': 40 },{ 'user': 'a', 'age': 36 }];
_.orderBy(users, ['user', 'age'], ['asc', 'desc']);
// => objects for [['a', 36], ['a', 34], ['b', 48], ['b', 40]]`,
    },

    {
        ...
        name: "_.partition",
        description:
            "Creates an array of elements split into two groups, the first of whichcontains elements predicate returns truthy for, the second of whichcontains elements predicate returns falsey for.",
...
// => objects for [['b'], ['c', 'a']]`,
...

    {
        ...
        exemple: `_.reject(users, (o) => !o.active);// => objects for ['fred']`,
    },
...
// => [6, 8, 10]`,
    },
    {
        ...
        exemple: `jQuery(element).on('click', _.before(5, addContactToList));
// => Allows adding up to 4 contacts to the list.`,
    },
    {
        ...
        exemple: `function greet(greeting, punctuation) {
...
bound('!');  // => 'hi fred!'`,
    ...
    // },
    {
        ...
        exemple: `// Avoid costly calculations while the window size is in flux.
jQuery(window).on('resize', _.debounce(calculateLayout, 150));`,
    ...
    },
    {
        ...
        exemple: `// Avoid excessively updating the position while scrolling.
...
//         exemple: `_.defaults({ 'a': 1 }, { 'b': 2 }, { 'a': 3 });// => { 'a': 1, 'b': 2 }`,
//     },

//     {
//         block: "Object",
//         name: "_.defaultsDeep(object, [sources])",
//         description:
//             "This method is like _.defaults except that it recursively assignsdefault properties.",
//         exemple: ``,
//     },
...
//         {
//         block: "String",
//         name: "_.truncate_.truncate([string=''], [options={}])",
//         description:
...
lodash_Cheat_Sheet.forEach((item, index, arr) => {
    ...
    if (index === 0 || item.block !== arr[index - 1].block) {
        table.append($(`<h3 class='caption' ${item.block === 'Collection' ? 'style="margin-top: 25px"': ''}></h3>`).text(item.block));
    }
